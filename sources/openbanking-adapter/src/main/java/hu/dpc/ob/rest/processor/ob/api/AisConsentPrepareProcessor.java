...
@Component("api-ob-ais-consent-prepare-processor")
public class AisConsentPrepareProcessor extends ApiPrepareProcessor {

    @Autowired
    public AisConsentPrepareProcessor(AccessRestClient accessRestClient, ApiService apiService) {
