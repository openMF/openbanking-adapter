...
@Component("api-ob-account-balances-processor")
public class AccountBalancesRequestProcessor implements Processor {

    private PspRestClient pspRestClient;

    @Autowired
    public AccountBalancesRequestProcessor(PspRestClient pspRestClient) {
