...
@Component("access-ob-accounts-held-processor")
public class AccountsHeldRequestProcessor implements Processor {

    private PspRestClient pspRestClient;

    @Autowired
    public AccountsHeldRequestProcessor(PspRestClient pspRestClient) {
