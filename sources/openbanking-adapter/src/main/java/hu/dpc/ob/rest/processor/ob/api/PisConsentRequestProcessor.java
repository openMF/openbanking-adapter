...
@Component("api-ob-pis-consent-processor")
public class PisConsentRequestProcessor extends ApiRequestProcessor {

    private ConsentService consentService;

    @Autowired
    public PisConsentRequestProcessor(ConsentService consentService) {
