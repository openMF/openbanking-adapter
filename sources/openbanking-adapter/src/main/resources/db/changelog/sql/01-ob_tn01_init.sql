...
CREATE TABLE `consent` (
  ...
  CONSTRAINT `uk_consent.scope` UNIQUE (`scope`, `client_id`, `user_id`),
...
CREATE TABLE `consent_status_step` (
  ...
  CONSTRAINT `uk_consent_status_step.seq` UNIQUE (`seq_no`),
...
CREATE TABLE `consent_transaction` (
  ...
  CONSTRAINT `uk_consent_transaction.seq` UNIQUE (`seq_no`),
